const movies = [
  ...
  function scoresAverage(moviesArray) {
    ...
    let ratings=moviesArray.filter((movie)=>{ return
        movie.score
    })

//     return moviesArray.reduce((a,b)=>{return(
// a+b/moviesArray.length
//     )
...
//     return 0
// }
// let goated=moviesArray.filter((directedBy)=>{
// directedBy.director=="Steven Spielberg" && directedBy.genre.includes('drama').length
// })
// return goated
// }
